kir-mapper workflow for Illumina WGS
=======
...
For whole genome Illumina data (WGS), you need a BAM file with reads aligned to the hg38 reference genome. Use the same reference as the 1000 Genomes Project (+decoys). Use BWA MEM to align your reads against the reference.
...
This is an example of how the plots should be.

![ncopy](image/ncopy_illumina_wgs.png)
